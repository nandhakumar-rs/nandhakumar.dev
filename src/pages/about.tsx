...
export default function AboutPage() {
  return (
    <div className="mx-auto mt-12">
      ...
      <section>
        <div>
          <h1 className="text-2xl font-bold text-app-primary-100 sm:text-3xl">
            Hi, I&apos;m Nandhakumar 👋
          </h1>
          <div className="mt-2 flex items-center gap-3 text-sm text-app-neutral-700 sm:text-base">
            <p>
        ...
        <p className="mt-4 text-base text-app-neutral-700 sm:text-lg">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-6 text-base text-app-neutral-700 sm:text-lg">
