...
description: 'Learn what is HTTP Request and how to use Route and Query Params in Nest.JS'
thumbnailUrl: '/images/post/nest-js-tutorial-3-route-and-query-param.png'
